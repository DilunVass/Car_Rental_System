                        ...
                        <main>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="tm-categories-container mb-5">
                                        ...
                                        <ul class="nav tm-category-list">
                                            ...
                                            <li class="nav-item tm-category-item"><a href="#" class="nav-link tm-category-link active">Adventure</a></li>
                                            <li class="nav-item tm-category-item"><a href="HomeFeatured.jsp" class="nav-link tm-category-link">Featured</a></li>
                                        </ul>
                                    </div>        
                                </div>
                            </div>
                           ...
                           <%
								try
								{
									...
									String query="select * from games where type='adventure'";
