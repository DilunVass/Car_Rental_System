                    ...
                    <div class="comment-form my-5 pt-5">
                        ...
                        <form action="addvehi" method = "post">
	                        <table class="table table-borderless mt-4">
                                ...
                                <tr>
                                    <td colspan="3"><input type="date" class="form-control" placeholder="Year" name="year" required/> </td>
                                    <td colspan="3"><input type="text" class="form-control" placeholder="rental" name="rental" required/> </td>
